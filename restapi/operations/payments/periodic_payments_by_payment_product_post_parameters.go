...
// PeriodicPaymentsByPaymentProductPostParams contains all the bound params for the periodic payments by payment product post operation
// typically these are obtained from a http.Request
//
// swagger:parameters PeriodicPaymentsByPaymentProductPost
...
//
// To ensure default values, the struct must have been initialized with NewPeriodicPaymentsByPaymentProductPostParams() beforehand.
func (o *PeriodicPaymentsByPaymentProductPostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PeriodicPaymentsRequest
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindConsentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindContentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) validateContentType(formats strfmt.Registry) error {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindDigest(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPSUCorporateID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPSUCorporateIDType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPSUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPSUIDType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPSUipAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindSignature(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindTPPNokRedirectURI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindTPPRedirectPreferred(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindTPPRedirectURI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindTPPSignatureCertificate(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *PeriodicPaymentsByPaymentProductPostParams) bindPaymentProduct(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PeriodicPaymentsByPaymentProductPostParams) validatePaymentProduct(formats strfmt.Registry) error {
