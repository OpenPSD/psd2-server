...
// AccountsBalancesByAccountIDGetParams contains all the bound params for the accounts balances by account Id get operation
// typically these are obtained from a http.Request
//
// swagger:parameters AccountsBalancesByAccountIdGet
...
//
// To ensure default values, the struct must have been initialized with NewAccountsBalancesByAccountIDGetParams() beforehand.
func (o *AccountsBalancesByAccountIDGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AccountsBalancesByAccountIDGetParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AccountsBalancesByAccountIDGetParams) bindConsentID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AccountsBalancesByAccountIDGetParams) bindDigest(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AccountsBalancesByAccountIDGetParams) bindSignature(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AccountsBalancesByAccountIDGetParams) bindTPPSignatureCertificate(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AccountsBalancesByAccountIDGetParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AccountsBalancesByAccountIDGetParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *AccountsBalancesByAccountIDGetParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
