...
// BulkPaymentsResponse Bulk Payments Response
// swagger:model BulkPaymentsResponse
type BulkPaymentsResponse struct {
...
// Validate validates this bulk payments response
func (m *BulkPaymentsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BulkPaymentsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateChallengeData(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateChosenScaMethod(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validatePaymentID(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateScaMethods(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateTppMessages(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateTransactionFees(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) validateTransactionStatus(formats strfmt.Registry) error {
...
func (m *BulkPaymentsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BulkPaymentsResponse) UnmarshalBinary(b []byte) error {
	var res BulkPaymentsResponse
